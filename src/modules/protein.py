...
def add_pdb_headers(prot: Protein, pdb_str: str) -> str:
    ...
    Useful during multi-chain recycling
    """
    out_pdb_lines = []
    lines = pdb_str.split("\n")
...
def to_modelcif(prot: Protein) -> str:
    """Converts a `Protein` instance to a ModelCIF string. Chains with identical modelled
    coordinates will be treated as the same polymer entity. But note that if chains differ in
    modelled regions, no attempt is made at identifying them as a single polymer entity.
